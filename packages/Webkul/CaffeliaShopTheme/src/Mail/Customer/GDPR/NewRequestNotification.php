...
namespace Caffelia\ShopTheme\Mail\Customer\GDPR;
...
class NewRequestNotification extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subjectKey = $this->gdprRequest->type === 'update'
            ? 'caffelia-shop::app.emails.customers.gdpr.new-update-request'
            : 'caffelia-shop::app.emails.customers.gdpr.new-delete-request';
    ...
    {
        return new Content(
            view: 'caffelia-shop::emails.customers.gdpr.new-request',
        );
    }
}
