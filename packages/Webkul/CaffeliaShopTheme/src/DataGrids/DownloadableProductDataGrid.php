...
class DownloadableProductDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index'      => 'increment_id',
            'label'      => trans('caffelia-shop::app.customers.account.downloadable-products.orderId'),
            'type'       => 'string',
            'filterable' => true,
            'sortable'   => true,
        ]);
        ...
        $this->addColumn([
            'index'      => 'product_name',
            'label'      => trans('caffelia-shop::app.customers.account.downloadable-products.title'),
            'type'       => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable'   => true,
        ...
        $this->addColumn([
            'index'           => 'created_at',
            'label'           => trans('caffelia-shop::app.customers.account.downloadable-products.date'),
            'type'            => 'date',
            'filterable'      => true,
        ...
        $this->addColumn([
            'index'              => 'status',
            'label'              => trans('caffelia-shop::app.customers.account.downloadable-products.status'),
            'type'               => 'string',
            'filterable'         => true,
            'filterable_type'    => 'dropdown',
            'filterable_options' => [
                [
                    'label' => trans('caffelia-shop::app.customers.account.downloadable-products.expired'),
                    'value' => self::STATUS_EXPIRED,
                ],
                [
                    'label' => trans('caffelia-shop::app.customers.account.downloadable-products.pending'),
                    'value' => self::STATUS_PENDING,
                ],
                [
                    'label' => trans('caffelia-shop::app.customers.account.downloadable-products.available'),
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    case self::STATUS_EXPIRED:
                        return '<p class="label-closed">'.trans('caffelia-shop::app.customers.account.downloadable-products.expired').'</p>';

                    case self::STATUS_PENDING:
                        return '<p class="label-pending">'.trans('caffelia-shop::app.customers.account.downloadable-products.pending').'</p>';

                    case self::STATUS_AVAILABLE:
                        return '<p class="label-active">'.trans('caffelia-shop::app.customers.account.downloadable-products.available').'</p>';
                }
            },
        ]);
        ...
        $this->addColumn([
            ...
            'label'           => trans('caffelia-shop::app.customers.account.downloadable-products.remaining-downloads'),
            'type'            => 'datetime',
            'filterable_type' => 'datetime_range',
            'sortable'        => true,
            'closure'         => function ($row) {
                if (! $row->download_bought) {
                    return trans('caffelia-shop::app.customer.account.downloadable_products.unlimited');
                }
