...
class OnepageController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->guard('customer')->user()?->is_suspended) {
            session()->flash('warning', trans('caffelia-shop::app.checkout.cart.suspended-account-message'));
        ...
        return view('caffelia-shop::checkout.onepage.index', compact('cart'));
    }
    ...
    public function success(OrderRepository $orderRepository)
    {
        ...
        return view('caffelia-shop::checkout.success', compact('order'));
    }
