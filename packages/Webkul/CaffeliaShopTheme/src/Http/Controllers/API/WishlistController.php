...
use Caffelia\ShopTheme\Http\Resources\WishlistResource;
...
class WishlistController extends APIController
{
    ...
    public function store(): JsonResource
    {
        ...
        if (! $product) {
            return new JsonResource([
                'message' => trans('caffelia-shop::app.customers.account.wishlist.product-removed'),
            ]);
        }
        ...
        if (! $this->wishlistRepository->findOneWhere($data)) {
            ...
            return new JsonResource([
                'message' => trans('caffelia-shop::app.customers.account.wishlist.success'),
            ]);
        }
        ...
        return new JsonResource([
            'message' => trans('caffelia-shop::app.customers.account.wishlist.removed'),
        ]);
    }
        ...
        try {
            ...
            if ($result) {
                return new JsonResource([
                    ...
                    'message'  => trans('caffelia-shop::app.customers.account.wishlist.moved-success'),
                ]);
            }
            ...
            return new JsonResource([
                ...
                'message'  => trans('caffelia-shop::app.checkout.cart.missing-options'),
            ]);
    ...
    public function destroy($id): JsonResource
    {
        ...
        if (! $success) {
            return new JsonResource([
                'message' => trans('caffelia-shop::app.customers.account.wishlist.remove-fail'),
            ]);
        }
