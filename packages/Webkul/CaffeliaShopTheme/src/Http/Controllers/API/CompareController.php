...
use Caffelia\ShopTheme\Http\Resources\CompareItemResource;
...
class CompareController extends APIController
{
    ...
    public function store()
    {
        ...
        if ($compareProduct) {
            return (new JsonResource([
                'message' => trans('caffelia-shop::app.compare.already-added'),
        ...
        return new JsonResource([
            'message' => trans('caffelia-shop::app.compare.item-add-success'),
        ]);
    }
    ...
    public function destroy(): JsonResource
    {
        ...
        if (! $success) {
            return new JsonResource([
                'message' => trans('caffelia-shop::app.compare.remove-error'),
            ]);
        }
        ...
        return new JsonResource([
            ...
            'message' => trans('caffelia-shop::app.compare.remove-success'),
        ]);
    }
    ...
    public function destroyAll(): JsonResource
    {
        ...
        return new JsonResource([
            'message' => trans('caffelia-shop::app.compare.remove-all-success'),
        ]);
    }
}
