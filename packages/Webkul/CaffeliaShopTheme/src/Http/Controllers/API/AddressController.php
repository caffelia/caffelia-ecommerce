...
use Caffelia\ShopTheme\Http\Resources\AddressResource;
...
class AddressController extends APIController
{
    ...
    public function store(AddressRequest $request): JsonResource
    {
        ...
        return new JsonResource([
            ...
            'message' => trans('caffelia-shop::app.customers.account.addresses.index.create-success'),
        ]);
    }
    ...
    public function update(AddressRequest $request): JsonResource
    {
        ...
        return new JsonResource([
            'data'    => new AddressResource($customerAddress),
            'message' => trans('caffelia-shop::app.customers.account.addresses.index.update-success'),
        ]);
    }
}
