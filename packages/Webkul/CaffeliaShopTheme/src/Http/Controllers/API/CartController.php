...
use Caffelia\ShopTheme\Http\Resources\CartResource;
use Caffelia\ShopTheme\Http\Resources\ProductResource;
...
class CartController extends APIController
{
    ...
    public function store()
    {
        ...
        try {
            if (! $product->status) {
                throw new \Exception(trans('caffelia-shop::app.checkout.cart.inactive-add'));
            }
            ...
            return new JsonResource(array_merge([
                ...
                'message' => trans('caffelia-shop::app.checkout.cart.item-add-to-cart'),
            ], $response));
    ...
    public function destroy(): JsonResource
    {
        ...
        return new JsonResource([
            ...
            'message' => trans('caffelia-shop::app.checkout.cart.success-remove'),
        ]);
    }
    ...
    public function destroySelected(): JsonResource
    {
        ...
        return new JsonResource([
            ...
            'message'  => trans('caffelia-shop::app.checkout.cart.index.remove-selected-success'),
        ]);
    }
    ...
    public function moveToWishlist(): JsonResource
    {
        ...
        return new JsonResource([
            'data'     => new CartResource(Cart::getCart()) ?? null,
            'message'  => trans('caffelia-shop::app.checkout.cart.index.move-to-wishlist-success'),
        ]);
    }
    ...
    public function update(): JsonResource
    {
        try {
            ...
            return new JsonResource([
                'data'    => new CartResource(Cart::getCart()),
                'message' => trans('caffelia-shop::app.checkout.cart.index.quantity-update'),
            ]);
        } catch (\Exception $exception) {
            return new JsonResource([
                'message' => $exception->getMessage(),
    ...
    public function storeCoupon()
    {
        ...
        try {
            if (strlen($validatedData['code'])) {
                ...
                if ($coupon->cart_rule->status) {
                    if (Cart::getCart()->coupon_code == $validatedData['code']) {
                        return (new JsonResource([
                            'data'     => new CartResource(Cart::getCart()),
                            'message'  => trans('caffelia-shop::app.checkout.coupon.already-applied'),
                        ]))->response()->setStatusCode(Response::HTTP_UNPROCESSABLE_ENTITY);
                    }
                    ...
                    if (Cart::getCart()->coupon_code == $validatedData['code']) {
                        return new JsonResource([
                            'data'     => new CartResource(Cart::getCart()),
                            'message'  => trans('caffelia-shop::app.checkout.coupon.success-apply'),
                        ]);
                    }
                }
            ...
            return (new JsonResource([
                'data'    => new CartResource(Cart::getCart()),
                'message' => trans('caffelia-shop::app.checkout.coupon.error'),
    ...
    public function destroyCoupon(): JsonResource
    {
        ...
        return new JsonResource([
            'data'     => new CartResource(Cart::getCart()),
            'message'  => trans('caffelia-shop::app.checkout.coupon.remove'),
        ]);
    }
