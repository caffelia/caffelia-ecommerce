...
use Caffelia\ShopTheme\Http\Requests\CartAddressRequest;
...
class OnepageController extends APIController
{
    ...
    public function validateOrder()
    {
        ...
        if (
            ...
            throw new \Exception(trans('caffelia-shop::app.checkout.cart.suspended-account-message'));
        }
        ...
        if (
            ...
            throw new \Exception(trans('caffelia-shop::app.checkout.cart.inactive-account-message'));
        }

        if (! Cart::haveMinimumOrderAmount()) {
            throw new \Exception(trans('caffelia-shop::app.checkout.cart.minimum-order-message', ['amount' => core()->currency($minimumOrderAmount)]));
        }

        if ($cart->haveStockableItems() && ! $cart->shipping_address) {
            throw new \Exception(trans('caffelia-shop::app.checkout.onepage.address.check-shipping-address'));
        }

        if (! $cart->billing_address) {
            throw new \Exception(trans('caffelia-shop::app.checkout.onepage.address.check-billing-address'));
        }
        ...
        if (
            ...
            throw new \Exception(trans('caffelia-shop::app.checkout.cart.specify-shipping-method'));
        }

        if (! $cart->payment) {
            throw new \Exception(trans('caffelia-shop::app.checkout.cart.specify-payment-method'));
        }
    }
}
