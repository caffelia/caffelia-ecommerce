...
namespace Caffelia\ShopTheme\Http\Controllers\Customer\Account;

use Illuminate\Support\Facades\Event;
use Webkul\Customer\Repositories\CustomerAddressRepository;
use Caffelia\ShopTheme\Http\Controllers\Controller;
use Caffelia\ShopTheme\Http\Requests\Customer\AddressRequest;
...
class AddressController extends Controller
{
    ...
    {
        return view('caffelia-shop::customers.account.addresses.index')->with('addresses', auth()->guard('customer')->user()->addresses);
    }
    ...
    {
        return view('caffelia-shop::customers.account.addresses.create');
    }
    ...
    public function store(AddressRequest $request)
    {
        ...
        session()->flash('success', trans('caffelia-shop::app.customers.account.addresses.index.create-success'));
    ...
    public function edit(int $id)
    {
        ...
        return view('caffelia-shop::customers.account.addresses.edit')->with('address', $address);
    }
    ...
    public function update(int $id, AddressRequest $request)
    {
        ...
        if (! $customer->addresses()->find($id)) {
            session()->flash('warning', trans('caffelia-shop::app.customers.account.addresses.index.security-warning'));
        ...
        session()->flash('success', trans('caffelia-shop::app.customers.account.addresses.index.edit-success'));
    ...
    public function makeDefault(int $id)
    {
        ...
        if ($addressToSetDefault) {
            ...
            session()->flash('success', trans('caffelia-shop::app.customers.account.addresses.index.default-delete'));
        }
    ...
    public function destroy(int $id)
    {
        ...
        session()->flash('success', trans('caffelia-shop::app.customers.account.addresses.index.delete-success'));
