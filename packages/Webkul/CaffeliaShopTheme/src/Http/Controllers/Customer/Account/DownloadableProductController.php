...
use Caffelia\ShopTheme\DataGrids\DownloadableProductDataGrid;
...
class DownloadableProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('caffelia-shop::customers.account.downloadable_products.index');
    }
    ...
    public function download($id)
    {
        ...
        if (
            ...
            session()->flash('warning', trans('caffelia-shop::app.customers.account.downloadable-products.download-error'));
