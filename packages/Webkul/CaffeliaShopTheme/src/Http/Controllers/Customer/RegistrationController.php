...
use Caffelia\ShopTheme\Http\Requests\Customer\RegistrationRequest;
use Caffelia\ShopTheme\Mail\Customer\EmailVerificationNotification;
use Caffelia\ShopTheme\Mail\Customer\RegistrationNotification;
...
class RegistrationController extends Controller
{
    ...
    {
        return view('caffelia-shop::customers.sign-up');
    }
    ...
    public function store(RegistrationRequest $registrationRequest)
    {
        ...
        if (core()->getConfigData('emails.general.notifications.emails.general.notifications.verification')) {
            session()->flash('success', trans('caffelia-shop::app.customers.signup-form.success-verify'));
        } else {
            session()->flash('success', trans('caffelia-shop::app.customers.signup-form.success'));
        }
    ...
    public function verifyAccount($token)
    {
        ...
        if ($customer) {
            ...
            session()->flash('success', trans('caffelia-shop::app.customers.signup-form.verified'));
        } else {
            session()->flash('warning', trans('caffelia-shop::app.customers.signup-form.verify-failed'));
        }
    ...
    public function resendVerificationEmail($email)
    {
        ...
        try {
            ...
            session()->flash('error', trans('caffelia-shop::app.customers.signup-form.verification-not-sent'));

            return redirect()->back();
        }

        session()->flash('success', trans('caffelia-shop::app.customers.signup-form.verification-sent'));
