...
use Caffelia\ShopTheme\DataGrids\GDPRRequestsDatagrid;
...
class GDPRController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('caffelia-shop::customers.account.gdpr.index');
    }
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('caffelia-shop::app.customers.account.gdpr.create-success'));
    ...
    public function pdfView()
    {
        ...
        $pdf = \PDF::loadView('caffelia-shop::customers.account.gdpr.pdf', compact('param'));
    ...
    public function htmlView()
    {
        ...
        return view('caffelia-shop::customers.account.gdpr.pdf', compact('param'));
    }
    ...
    {
        return view('caffelia-shop::components.layouts.cookie.consent');
    }
    ...
    public function revoke($id)
    {
        ...
        if (! $data) {
            session()->flash('error', trans('caffelia-shop::app.customers.account.gdpr.revoke-failed'));
        ...
        session()->flash('success', trans('caffelia-shop::app.customers.account.gdpr.revoked-successfully'));
