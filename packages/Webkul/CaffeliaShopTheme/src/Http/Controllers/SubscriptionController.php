...
class SubscriptionController extends Controller
{
    ...
    public function store()
    {
        ...
        if ($subscription) {
            session()->flash('error', trans('caffelia-shop::app.subscription.already'));
        ...
        session()->flash('success', trans('caffelia-shop::app.subscription.subscribe-success'));
    ...
    public function destroy($token)
    {
        ...
        session()->flash('success', trans('caffelia-shop::app.subscription.unsubscribe-success'));
