...
use Caffelia\ShopTheme\Http\Controllers\Customer\Account\AddressController;
use Caffelia\ShopTheme\Http\Controllers\Customer\Account\DownloadableProductController;
use Caffelia\ShopTheme\Http\Controllers\Customer\Account\OrderController;
use Caffelia\ShopTheme\Http\Controllers\Customer\Account\WishlistController;
use Caffelia\ShopTheme\Http\Controllers\Customer\CustomerController;
use Caffelia\ShopTheme\Http\Controllers\Customer\ForgotPasswordController;
use Caffelia\ShopTheme\Http\Controllers\Customer\GDPRController;
use Caffelia\ShopTheme\Http\Controllers\Customer\RegistrationController;
use Caffelia\ShopTheme\Http\Controllers\Customer\ResetPasswordController;
use Caffelia\ShopTheme\Http\Controllers\Customer\SessionController;
use Caffelia\ShopTheme\Http\Controllers\DataGridController;
