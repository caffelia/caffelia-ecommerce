...
use Caffelia\ShopTheme\Http\Controllers\API\AddressController;
use Caffelia\ShopTheme\Http\Controllers\API\CartController;
use Caffelia\ShopTheme\Http\Controllers\API\CategoryController;
use Caffelia\ShopTheme\Http\Controllers\API\CompareController;
use Caffelia\ShopTheme\Http\Controllers\API\CoreController;
use Caffelia\ShopTheme\Http\Controllers\API\CustomerController;
use Caffelia\ShopTheme\Http\Controllers\API\OnepageController;
use Caffelia\ShopTheme\Http\Controllers\API\ProductController;
use Caffelia\ShopTheme\Http\Controllers\API\ReviewController;
use Caffelia\ShopTheme\Http\Controllers\API\WishlistController;
