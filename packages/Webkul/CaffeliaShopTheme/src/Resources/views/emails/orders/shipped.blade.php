@component('caffelia-shop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            @lang('caffelia-shop::app.emails.orders.shipped.title')
        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('caffelia-shop::app.emails.dear', ['customer_name' => $shipment->order->customer_full_name]),👋
        </p>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('caffelia-shop::app.emails.orders.shipped.greeting', [
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        @lang('caffelia-shop::app.emails.orders.shipped.summary')
    </div>
        ...
        @if ($shipment->order->shipping_address)
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px;font-weight: 400;color: #384860;margin-bottom: 40px;">
                    ...
                    @lang('caffelia-shop::app.emails.orders.contact') : {{ $shipment->order->billing_address->phone }}
                </div>
                ...
                <div style="font-size: 16px; color: #384860;">
                    <div>
                        <span>
                            @lang('caffelia-shop::app.emails.orders.carrier') :
                        </span>
                    ...
                    <div>
                        <span>
                            @lang('caffelia-shop::app.emails.orders.tracking-number', ['tracking_number' =>  $shipment->track_number])
                        </span>
                    </div>
                </div>
