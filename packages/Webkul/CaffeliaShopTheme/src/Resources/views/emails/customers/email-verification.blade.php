@component('caffelia-shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #384860;line-height: 24px;">
            @lang('caffelia-shop::app.emails.customers.verification.greeting')
        </p>
    </div>

    <p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 40px">
        @lang('caffelia-shop::app.emails.customers.verification.description')
    </p>
    ...
    <div style="display: flex;margin-bottom: 95px">
        ...
        >
            @lang('caffelia-shop::app.emails.customers.verification.verify-email')
        </a>
    </div>
@endcomponent