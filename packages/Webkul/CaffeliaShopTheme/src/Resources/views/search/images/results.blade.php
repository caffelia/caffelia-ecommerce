<v-image-search-result-component>
    <div class="mt-8 rounded-lg border border-gray-200 p-5 max-sm:grid max-sm:gap-y-2.5 max-sm:p-2.5">
        <div class="flex gap-12 max-sm:items-center max-sm:gap-4">
            <x-caffelia-shop::media.images.lazy class="h-[110px] max-h-[110px] w-[110px] min-w-[110px] max-w-[110px] rounded-sm max-sm:h-[60px] max-sm:max-h-[60px] max-sm:min-h-[60px] max-sm:w-[60px] max-sm:min-w-[60px] max-sm:max-w-[60px] max-sm:rounded-xl" />
            ...
            <div class="flex gap-12 max-sm:items-center max-sm:gap-4">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-2xl font-medium max-sm:text-base">
                        @lang('caffelia-shop::app.search.images.results.analyzed-keywords')
                    </h2>
