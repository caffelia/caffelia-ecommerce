<v-image-search>
    <button
        ...
        aria-label="@lang('caffelia-shop::app.search.images.index.search')"
    >
    </button>
</v-image-search>
                    ...
                    if (imageInput.files && imageInput.files[0]) {
                        if (imageInput.files[0].type.includes('image/')) {
                            if (imageInput.files[0].size <= 2000000) {
                                    ...
                                    .then(response => {
                                        ...
                                        async function app() {
                                            ...
                                            try {
                                                ...
                                                this.$emitter.emit('add-flash', { type: 'error', message: "@lang('caffelia-shop::app.search.images.index.something-went-wrong')"});
                                            }
                                ...
                                this.$emitter.emit('add-flash', { type: 'error', message: '@lang('caffelia-shop::app.search.images.index.size-limit-error')'});
                            ...
                            this.$emitter.emit('add-flash', { type: 'error', message: '@lang('caffelia-shop::app.search.images.index.only-images-allowed')'});
