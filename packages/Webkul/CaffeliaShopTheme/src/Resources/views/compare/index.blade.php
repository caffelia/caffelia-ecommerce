<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('caffelia-shop::app.compare.title')"/>

    <meta name="keywords" content="@lang('caffelia-shop::app.compare.title')"/>
@endPush

<x-caffelia-shop::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.compare.title')
    </x-slot>
    ...
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        <div class="mt-5 flex justify-center max-lg:hidden">
            ...
            <div class="flex items-center gap-x-2.5">
                <x-caffelia-shop::breadcrumbs name="compare" />
            </div>
    ...
    <div class="container mt-8 px-[60px] max-lg:px-8 max-md:mt-7 max-md:px-0">
        <v-compare>
            <!-- Shimmer Effect -->
            <x-caffelia-shop::shimmer.compare :attributeCount="count($comparableAttributes)" />
        </v-compare>
    </div>
                ...
                <div v-if="! isLoading">
                    <div class="flex items-center justify-between max-md:px-4">
                        ...
                        >
                            ...
                            @lang('caffelia-shop::app.compare.delete-all')
                        </div>
                            ...
                            >
                                ...
                                <div class="flex gap-3 border-zinc-200 max-md:gap-0 max-md:border-0 ltr:border-l-[1px] rtl:border-r-[1px]">
                                    ...
                                    >
                                        ...
                                        <x-caffelia-shop::products.card class="[&_span.icon-compare]:hidden" />
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <img
                            ...
                            alt="@lang('caffelia-shop::app.compare.empty-text')"
                        />
                        ...
                        <p
                            ...
                            role="heading"
                        >
                            @lang('caffelia-shop::app.compare.empty-text')
                        </p>
                    </div>
                </div>
                        ...
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                if (! this.isCustomer) {
                                    ...
                                    this.$emitter.emit('add-flash', { type: 'success', message:  "@lang('caffelia-shop::app.compare.remove-all-success')" });
