            ...
            >
                <div class="mt-8 max-sm:mt-0">
                    ...
                    <div class="mb-2.5 mt-5 flex items-center justify-between">
                        <p class="text-sm">
                            @lang('caffelia-shop::app.products.view.type.simple.customizable-options.total-amount')
                        </p>
            ...
            >
                <div class="mt-8 border-b border-zinc-200 pb-4 max-sm:mt-4 max-sm:pb-0">
                    <x-caffelia-shop::form.control-group>
                            ...
                            <div class="grid gap-2 max-sm:gap-1">
                                ...
                                >
                                    ...
                                    <label
                                        ...
                                        :for="'customizable_options[' + option.id + '][' + index + ']'"
                                    >
                                        @lang('caffelia-shop::app.products.view.type.simple.customizable-options.none')
                                    </label>
                                </div>
                        ...
                        <x-caffelia-shop::form.control-group.error ::name="'customizable_options[' + option.id + '][]'" />
                    </x-caffelia-shop::form.control-group>
                </div>
            </script>
