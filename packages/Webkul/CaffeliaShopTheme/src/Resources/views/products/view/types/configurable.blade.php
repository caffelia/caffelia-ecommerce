                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                @lang('caffelia-shop::app.products.view.type.configurable.select-above-options')
                            </span>
                        </div>
                    </template>
            ...
            app.component('v-product-configurable-options', {
                ...
                methods: {
                    ...
                    fillAttributeOptions(attribute) {
                        ...
                        attribute.options = [{
                            'id': '',
                            'label': "@lang('caffelia-shop::app.products.view.type.configurable.select-options')",
                            'products': []
                        }];
