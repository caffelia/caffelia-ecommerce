        ...
        >
            <div class="mt-8 max-sm:mt-0">
                ...
                <div class="mb-2.5 mt-5 flex items-center justify-between">
                    <p class="text-sm">
                        @lang('caffelia-shop::app.products.view.type.bundle.total-amount')
                    </p>
                ...
                <x-caffelia-shop::form.control-group>
                    ...
                    <template v-if="option.type == 'select'">
                        ...
                        >
                            ...
                            >
                                @lang('caffelia-shop::app.products.view.type.bundle.none')
                            </option>
                    ...
                    <x-caffelia-shop::form.control-group.error ::name="'bundle_options[' + option.id + '][]'" />
                </x-caffelia-shop::form.control-group>
