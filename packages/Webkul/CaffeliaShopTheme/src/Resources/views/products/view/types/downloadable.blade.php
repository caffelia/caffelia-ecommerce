@if ($product->type == 'downloadable')
    ...
    @if ($product->downloadable_samples->count())
        <div class="sample-list mb-6 mt-8">
            <label class="mb-3 flex font-medium">
                @lang('caffelia-shop::app.products.view.type.downloadable.samples')
            </label>
    ...
    @if ($product->downloadable_links->count())
        <label class="mb-4 mt-8 flex font-medium max-sm:mb-1.5 max-sm:mt-3">
            @lang('caffelia-shop::app.products.view.type.downloadable.links')
        </label>
                ...
                <div class="flex select-none items-center gap-x-4">
                    <div class="flex items-center">
                        <v-field
                            ...
                            class="peer hidden"
                            rules="required"
                            label="@lang('caffelia-shop::app.products.view.type.downloadable.links')"
                        >
                        </v-field>
                    ...
                    @if (
                        ...
                        >
                            @lang('caffelia-shop::app.products.view.type.downloadable.sample')
                        </a>
                    @endif
                </div>
            @endforeach
