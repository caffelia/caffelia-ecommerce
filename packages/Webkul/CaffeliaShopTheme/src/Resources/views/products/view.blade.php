...
<x-caffelia-shop::layouts>
    ...
    <v-product>
        <x-caffelia-shop::shimmer.products.view />
    </v-product>
        ...
        <div class="max-1180:hidden">
            ...
            >
                ...
                <x-caffelia-shop::tabs.item
                    ...
                    :title="trans('caffelia-shop::app.products.view.description')"
                    :is-selected="true"
                >
                ...
                @if(count($attributeData))
                    <x-caffelia-shop::tabs.item
                        id="information-tab"
                        class="container mt-[60px] !p-0"
                        :title="trans('caffelia-shop::app.products.view.additional-information')"
                        :is-selected="false"
                    >
                        <div class="container mt-[60px] max-1180:px-5">
                ...
                <x-caffelia-shop::tabs.item
                    id="review-tab"
                    class="container mt-[60px] !p-0"
                    :title="trans('caffelia-shop::app.products.view.review')"
                    :is-selected="false"
                >
                    @include('caffelia-shop::products.view.reviews')
                </x-caffelia-shop::tabs.item>
            </x-caffelia-shop::tabs>
        </div>
    </div>
    ...
    <div class="container mt-6 grid gap-3 !p-0 max-1180:px-5 1180:hidden">
        ...
        >
            <x-slot:header class="bg-gray-100 max-md:!py-3 max-sm:!py-2">
                <p class="text-base font-medium 1180:hidden">
                    @lang('caffelia-shop::app.products.view.description')
                </p>
            </x-slot>
        ...
        @if (count($attributeData))
            ...
            >
                <x-slot:header class="bg-gray-100 max-md:!py-3 max-sm:!py-2">
                    <p class="text-base font-medium 1180:hidden">
                        @lang('caffelia-shop::app.products.view.additional-information')
                    </p>
                </x-slot>
        ...
        >
            ...
            >
                <p class="text-base font-medium">
                    @lang('caffelia-shop::app.products.view.review')
                </p>
            </x-slot>
    ...
    <x-caffelia-shop::products.carousel
        :title="trans('caffelia-shop::app.products.view.related-product-title')"
        :src="route('shop.api.products.related.index', ['id' => $product->id])"
    />

    <!-- Up-sell Products -->
    <x-caffelia-shop::products.carousel
        :title="trans('caffelia-shop::app.products.view.up-sell-title')"
                ...
                >
                    ...
                    <div class="container px-[60px] max-1180:px-0">
                        <div class="mt-12 flex gap-9 max-1180:flex-wrap max-lg:mt-0 max-sm:gap-y-4">
                            ...
                            @include('caffelia-shop::products.view.gallery')
                            ...
                            <div class="relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                ...
                                <div class="flex justify-between gap-4">
                                    ...
                                    @if (core()->getConfigData('customer.settings.wishlist.wishlist_option'))
                                        <div
                                            ...
                                            role="button"
                                            aria-label="@lang('caffelia-shop::app.products.view.add-to-wishlist')"
                                            tabindex="0"
                                ...
                                @if ($totalRatings = $reviewHelper->getTotalFeedback($product))
                                    ...
                                    >
                                        <x-caffelia-shop::products.ratings
                                ...
                                @if (\Webkul\Tax\Facades\Tax::isInclusiveTaxProductPrices())
                                    <span class="text-sm font-normal text-zinc-500 max-sm:text-xs">
                                        (@lang('caffelia-shop::app.products.view.tax-inclusive'))
                                    </span>
                                @endif
                                ...
                                @include('caffelia-shop::products.view.types.simple')

                                @include('caffelia-shop::products.view.types.configurable')

                                @include('caffelia-shop::products.view.types.grouped')

                                @include('caffelia-shop::products.view.types.bundle')

                                @include('caffelia-shop::products.view.types.downloadable')

                                @include('caffelia-shop::products.view.types.booking')
                                ...
                                <div class="mt-8 flex max-w-[470px] gap-4 max-sm:mt-4">
                                    ...
                                    @if ($product->getTypeInstance()->showQuantityBox())
                                        <x-caffelia-shop::quantity-changer
                                            name="quantity"
                                            value="1"
                                    ...
                                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                        ...
                                        <x-caffelia-shop::button
                                            ...
                                            :loading="false"
                                            :title="trans('caffelia-shop::app.products.view.add-to-cart')"
                                ...
                                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                    ...
                                    @if (core()->getConfigData('catalog.products.storefront.buy_now_button_display'))
                                        <x-caffelia-shop::button
                                            ...
                                            :title="trans('caffelia-shop::app.products.view.buy-now')"
                                            :disabled="! $product->isSaleable(1)"
                                ...
                                <div class="mt-10 flex gap-9 max-md:mt-4 max-md:flex-wrap max-sm:justify-center max-sm:gap-3">
                                    ...
                                    >
                                        @if (core()->getConfigData('catalog.products.settings.compare_option'))
                                            ...
                                            @lang('caffelia-shop::app.products.view.compare')
                                        @endif
                                    </div>
                    ...
                    addToCompare(productId) {
                        ...
                        if (existingItems.length) {
                            if (! existingItems.includes(productId)) {
                                ...
                                this.$emitter.emit('add-flash', { type: 'success', message: "@lang('caffelia-shop::app.products.view.add-to-compare')" });
                            } else {
                                this.$emitter.emit('add-flash', { type: 'warning', message: "@lang('caffelia-shop::app.products.view.already-in-compare')" });
                            }
                        } else {
