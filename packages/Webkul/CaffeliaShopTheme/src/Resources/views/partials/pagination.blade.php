@if ($paginator->hasPages())
    <div class="flex items-center justify-between p-6">
        <p class="text-xs font-medium">
            @lang('caffelia-shop::app.partials.pagination.pagination-showing', [
                ...
                <li>
                    ...
                    @else
                        <a 
                            ...
                            aria-label="{{ trans('caffelia-shop::app.partials.pagination.prev-page') }}"
                        >
                ...
                <li>
                    @if ($paginator->hasMorePages())
                        <a 
                            ...
                            aria-label="{{ trans('caffelia-shop::app.partials.pagination.next-page') }}"
                        >
