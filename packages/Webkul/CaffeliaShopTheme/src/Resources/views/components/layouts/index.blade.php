...
>
    ...
    <body>
        ...
        <div id="app">
            ...
            <x-caffelia-shop::flash-group />

            <!-- Confirm Modal Blade Component -->
            <x-caffelia-shop::modal.confirm />

            <!-- Page Header Blade Component -->
            @if ($hasHeader)
                <x-caffelia-shop::layouts.header />
            @endif
            ...
            @if(
                ...
                <x-caffelia-shop::layouts.cookie />
            @endif
            ...
            @if ($hasFeature)
                <x-caffelia-shop::layouts.services />
            @endif

            <!-- Page Footer Blade Component -->
            @if ($hasFooter)
                <x-caffelia-shop::layouts.footer />
            @endif
        </div>
