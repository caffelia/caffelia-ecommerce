...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 px-16">
            ...
            <!-- Currency Switcher -->
            <x-caffelia-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'left' : 'right' }}">
                <!-- Dropdown Toggler -->
                <x-slot:toggle>
                    <div
                ...
                <x-slot:toggle>
                    ...
                    >
                        <img
                            ...
                            class="h-full"
                            alt="@lang('caffelia-shop::app.components.layouts.header.desktop.top.default-locale')"
                            width="24"
                            height="16"
                        />
