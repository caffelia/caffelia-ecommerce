...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        <a
            ...
            aria-label="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.bagisto')"
        >
            <img
        ...
        <div class="relative w-full">
            ...
            >
                <label
                    ...
                    class="sr-only"
                >
                    @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.search')
                </label>
                ...
                <input
                    ...
                    placeholder="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.search-text')"
                    aria-label="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.search-text')"
                    aria-required="true"
                    pattern="[^\\]+"
                    required
                >
                ...
                <button
                    type="submit"
                    class="hidden"
                    aria-label="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.submit')"
                >
                </button>

                @if (core()->getConfigData('catalog.products.settings.image_search'))
                    @include('caffelia-shop::search.images.index')
                @endif
            </form>
        </div>
        ...
        <div class="mt-1.5 flex gap-x-8 max-[1100px]:gap-x-6 max-lg:gap-x-8">
            ...
            @if(core()->getConfigData('catalog.products.settings.compare_option'))
                <a
                    ...
                    aria-label="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.compare')"
                >
                    <span
            ...
            @if(core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                @include('caffelia-shop::checkout.cart.mini-cart')
            @endif
            ...
            <!-- user profile -->
            <x-caffelia-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                <x-slot:toggle>
                    <span
                        class="icon-users inline-block cursor-pointer text-2xl"
                        role="button"
                        aria-label="@lang('caffelia-shop::app.components.layouts.header.desktop.bottom.profile')"
                        tabindex="0"
                    ></span>
                </x-slot>
                    ...
                    <x-slot:content>
                        <div class="grid gap-2.5">
                            <p class="font-dmserif text-xl">
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.welcome-guest')
                            </p>

                            <p class="text-sm">
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.dropdown-text')
                            </p>
                        </div>
                        ...
                        <div class="mt-6 flex gap-4">
                            ...
                            >
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.sign-in')
                            </a>
                            ...
                            >
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.sign-up')
                            </a>
                ...
                @auth('customer')
                    <x-slot:content class="!p-0">
                        <div class="grid gap-2.5 p-5 pb-0">
                            <p class="font-dmserif text-xl">
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.welcome')’
                        ...
                        <div class="mt-2.5 grid gap-1 pb-2.5">
                            ...
                            >
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.profile')
                            </a>
                            ...
                            >
                                @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.orders')
                            </a>
                            ...
                            @if (core()->getConfigData('customer.settings.wishlist.wishlist_option'))
                                ...
                                >
                                    @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.wishlist')
                                </a>
                            @endif
                            ...
                            @auth('customer')
                                ...
                                >
                                    @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.logout')
                                </a>
                            @endauth
            ...
            <div class="flex items-center">
                ...
                >
                    <span class="flex items-center gap-1 px-5 uppercase">
                        ...
                        @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.all')
                    </span>
                </div>
                ...
                <x-slot:header class="border-b border-gray-200">
                    <div class="flex w-full items-center justify-between">
                        <p class="text-xl font-medium">
                            @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.categories')
                        </p>
                    </div>
                </x-slot>
                                ...
                                <div class="border-b border-gray-200 px-6 py-4">
                                    ...
                                    >
                                        ...
                                        <p class="text-base font-medium text-black">
                                            @lang('caffelia-shop::app.components.layouts.header.desktop.bottom.back-button')
                                        </p>
                                    </button>
                                </div>
