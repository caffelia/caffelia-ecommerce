...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "@lang('caffelia-shop::app.components.modal.confirm.title')",
                    message = "@lang('caffelia-shop::app.components.modal.confirm.message')",
                    options = {
                        btnDisagree: "@lang('caffelia-shop::app.components.modal.confirm.disagree-btn')",
                        btnAgree: "@lang('caffelia-shop::app.components.modal.confirm.agree-btn')",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
