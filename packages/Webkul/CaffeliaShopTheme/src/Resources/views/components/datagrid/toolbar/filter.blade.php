    ...
    >
        ...
        >
            <template v-if="isLoading">
                <x-caffelia-shop::shimmer.datagrid.toolbar.filter />
            </template>
                ...
                >
                        ...
                        >
                            <span class="flex items-center justify-between gap-1.5">
                                ...
                                <span class="max-md:hidden">
                                    @lang('caffelia-shop::app.components.datagrid.toolbar.filter.title')
                                </span>
                            </span>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:header class="border-b border-zinc-200 !px-4">
                        <p class="text-lg font-semibold">
                            @lang('caffelia-shop::app.components.datagrid.toolbar.filter.apply-filter')
                        </p>
                    </x-slot>
                                    ...
                                    <template v-if="column.filterable_type === 'dropdown'">
                                        <div class="flex items-center justify-between">
                                            ...
                                            >
                                                ...
                                                >
                                                    @lang('caffelia-shop::app.components.datagrid.toolbar.filter.custom-filters.clear-all')
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <x-caffelia-shop::dropdown>
                                                <x-slot:toggle>
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            v-text="'@lang('caffelia-shop::app.components.datagrid.toolbar.filter.dropdown.select')'"
                                ...
                                <template v-else-if="column.type === 'date'">
                                    ...
                                    <template v-if="column.filterable_type === 'date_range'">
                                        ...
                                        <div class="mt-4 grid grid-cols-2 gap-1.5 max-sm:my-2">
                                            ...
                                            <x-caffelia-shop::flat-picker.date ::allow-input="false">
                                                <input
                                                    type="date"
                                                ...
                                                />
                                            </x-caffelia-shop::flat-picker.date>
                                ...
                                <template v-else-if="column.type === 'datetime'">
                                    ...
                                    <template v-if="column.filterable_type === 'datetime_range'">
                                        ...
                                        <div class="my-4 grid grid-cols-2 gap-1.5">
                                            ...
                                            <x-caffelia-shop::flat-picker.datetime ::allow-input="false">
                                                <input
                                                    type="datetime-local"
                                                    :name="`${column.index}[from]`"
                                                    value=""
                                                ...
                                                />
                                            </x-caffelia-shop::flat-picker.datetime>
