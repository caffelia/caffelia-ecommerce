...
>
    <x-caffelia-shop::shimmer.categories.carousel
        :count="8"
        ...
        >
            <div class="relative">
                ...
                <span
                    ...
                    role="button"
                    aria-label="@lang('caffelia-shop::components.carousel.previous')"
                    tabindex="0"
                    @click="swipeLeft"
                >
                </span>
                ...
                <span
                    ...
                    role="button"
                    aria-label="@lang('caffelia-shop::components.carousel.next')"
                    tabindex="0"
                    @click="swipeRight"
                >
                </span>
