...
<div v-if="! isMobile">
    ...
    >
        ...
        <x-caffelia-shop::shimmer.categories.filters />
    </v-filters>
</div>
    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('caffelia-shop::app.categories.filters.filter')
            </div>
        </x-slot>
        ...
        <x-slot:header>
            <div class="flex items-center justify-between">
                <p class="text-lg font-semibold">
                    @lang('caffelia-shop::app.categories.filters.filters')
                </p>
                ...
                >
                    @lang('caffelia-shop::app.categories.filters.clear-all')
                </p>
            </div>
        </x-slot>
    ...
    >
        ...
        <x-slot:toggle>
            ...
            >
                ...
                @lang('caffelia-shop::app.categories.filters.sort')
            </div>
        </x-slot>
        ...
        <x-slot:content class="!px-0">
            @include('caffelia-shop::categories.toolbar')
        </x-slot>
    </x-caffelia-shop::drawer>
</div>
...
@pushOnce('scripts')
    ...
    >
        <x-caffelia-shop::accordion class="last:border-b-0">
            <!-- Filter Item Header -->
                    ...
                    >
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="@lang('caffelia-shop::app.categories.filters.search.title')"
                                v-model="searchQuery"
                        ...
                        <p
                            ...
                            v-text="
                                '@lang('caffelia-shop::app.categories.filters.search.results-info', ['currentCount' => 'currentCount', 'totalCount' => 'totalCount'])'
                    ...
                    <ul class="pb-3 text-base text-gray-700">
                        ...
                        <template v-else>
                            <li
                                ...
                                v-if="! isLoadingMore"
                            >
                                @lang('caffelia-shop::app.categories.filters.search.no-options-available')
                            </li>
                    ...
                    <div class="flex justify-center pb-3" v-if="meta && meta.current_page < meta.last_page">
                        ...
                        >
                            <span v-if="isLoadingMore">
                                @lang('caffelia-shop::app.categories.filters.search.loading')
                            </span>

                            <span v-else>
                                @lang('caffelia-shop::app.categories.filters.search.load-more')
                            </span>
                        </button>
                    </div>
                </template>
    ...
    >
        <div>
            ...
            <template v-if="isLoading">
                <x-caffelia-shop::shimmer.range-slider />
            </template>
