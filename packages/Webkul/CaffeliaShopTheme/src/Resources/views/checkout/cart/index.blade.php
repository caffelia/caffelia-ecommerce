<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('caffelia-shop::app.checkout.cart.index.cart')"/>

    <meta name="keywords" content="@lang('caffelia-shop::app.checkout.cart.index.cart')"/>
@endPush
...
>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.checkout.cart.index.cart')
    </x-slot>
        ...
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] py-4 max-lg:px-8 max-md:px-4">
            <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
                ...
                <a
                    ...
                    aria-label="@lang('caffelia-shop::app.checkout.cart.index.bagisto')"
                >
                    <img
            ...
            @guest('customer')
                @include('caffelia-shop::checkout.login')
            @endguest
        </div>
    </div>
    ...
    <div class="flex-auto">
        <div class="container px-[60px] max-lg:px-8 max-md:px-4">
            ...
            @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
                <x-caffelia-shop::breadcrumbs name="cart" />
            @endif
            ...
            <v-cart ref="vCart">
                <!-- Cart Shimmer Effect -->
                <x-caffelia-shop::shimmer.checkout.cart :count="3" />
            </v-cart>
        </div>
    </div>
    ...
    @if (core()->getConfigData('sales.checkout.shopping_cart.cross_sell'))
        ...
        <x-caffelia-shop::products.carousel
            :title="trans('caffelia-shop::app.checkout.cart.index.cross-sell.title')"
            ...
            <div>
                ...
                <template v-else>
                    ...
                    >
                        <div class="flex flex-1 flex-col gap-6 max-md:gap-5">
                            ...
                            <div class="flex items-center justify-between border-b border-zinc-200 pb-2.5 max-md:py-2.5">
                                <div class="flex select-none items-center">
                                    ...
                                    <label
                                        ...
                                        for="select-all"
                                        tabindex="0"
                                        aria-label="@lang('caffelia-shop::app.checkout.cart.index.select-all')"
                                    ...
                                    <span
                                        ...
                                        aria-level="2"
                                    >
                                        @{{ "@lang('caffelia-shop::app.checkout.cart.index.items-selected')".replace(':count', selectedItemsCount) }}
                                    </span>
                                </div>
                                ...
                                <div v-if="selectedItemsCount">
                                    ...
                                    >
                                        @lang('caffelia-shop::app.checkout.cart.index.remove')
                                    </span>
                                    ...
                                    @if (auth()->guard()->check())
                                        ...
                                        >
                                            @lang('caffelia-shop::app.checkout.cart.index.move-to-wishlist')
                                        </span>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="flex gap-x-5">
                                        <div class="mt-11 select-none max-md:mt-9 max-sm:mt-7">
                                            ...
                                            <label
                                                ...
                                                :for="'item_' + item.id"
                                                tabindex="0"
                                                aria-label="@lang('caffelia-shop::app.checkout.cart.index.select-cart-item')"
                                        ...
                                        <div class="grid place-content-start gap-y-2.5 max-md:gap-y-0">
                                            ...
                                            >
                                                ...
                                                <div class="">
                                                    ...
                                                    >
                                                        @lang('caffelia-shop::app.checkout.cart.index.see-details')
                                    ...
                                    <div class="text-right max-md:hidden">
                                        ...
                                        <template v-else-if="displayTax.prices == 'both'">
                                            <p class="flex flex-col text-lg font-semibold">
                                                ...
                                                <span class="text-xs font-normal">
                                                    @lang('caffelia-shop::app.checkout.cart.index.excl-tax')
                            ...
                            <div class="flex flex-wrap justify-end gap-8 max-md:justify-between max-md:gap-5">
                                ...
                                <a
                                    ...
                                    href="{{ route('shop.home.index') }}"
                                >
                                    @lang('caffelia-shop::app.checkout.cart.index.continue-shopping')
                                </a>
                                ...
                                <x-caffelia-shop::button
                                    class="secondary-button max-h-14 rounded-2xl max-md:rounded-lg max-md:px-6 max-md:py-3 max-md:text-sm max-sm:py-2"
                                    :title="trans('caffelia-shop::app.checkout.cart.index.update-cart')"
                                    ::loading="isStoring"
                                    ::disabled="isStoring"
                                    @click="update()"
                                />
                        ...
                        @include('caffelia-shop::checkout.cart.summary')
                    ...
                    >
                        <img
                            ...
                            alt="@lang('caffelia-shop::app.checkout.cart.index.empty-product')"
                        />
                        ...
                        <p
                            ...
                            role="heading"
                        >
                            @lang('caffelia-shop::app.checkout.cart.index.empty-product')
                        </p>
                    </div>
                </template>
            </div>
