...
>
    <x-slot:header class="font-semibold max-md:py-3 max-md:font-medium max-sm:p-2 max-sm:text-sm">
        @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.title')
    </x-slot>
        ...
        >
            <form @change="handleSubmit($event, estimateShipping)">
                <p class="mb-4 max-sm:text-sm">
                    @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.info')
                </p>
                
                <!-- Country -->
                <x-caffelia-shop::form.control-group class="!mb-2.5">
                    <x-caffelia-shop::form.control-group.label class="{{ core()->isCountryRequired() ? 'required' : '' }}">
                        @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.country')
                    ...
                    <x-caffelia-shop::form.control-group.control
                        ...
                        :label="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.country')"
                        :placeholder="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.country')"
                    >
                        <option value="">
                            @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.select-country')
                        </option>
                    ...
                    <x-caffelia-shop::form.control-group.error name="country" />
                ...
                <x-caffelia-shop::form.control-group>
                    <x-caffelia-shop::form.control-group.label class="{{ core()->isStateRequired() ? 'required' : '' }}">
                        @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.state')
                    </x-caffelia-shop::form.control-group.label>
                    ...
                    <template v-if="states">
                        <template v-if="haveStates">
                            <x-caffelia-shop::form.control-group.control
                                ...
                                :label="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.state')"
                                :placeholder="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.state')"
                            >
                                <option value="">
                                    @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.select-state')
                                </option>
                    ...
                    <x-caffelia-shop::form.control-group.error name="state" />
                </x-caffelia-shop::form.control-group>
                ...
                <x-caffelia-shop::form.control-group class="!mb-0">
                    <x-caffelia-shop::form.control-group.label class="{{ core()->isPostCodeRequired() ? 'required' : '' }}">
                        @lang('caffelia-shop::app.checkout.cart.summary.estimate-shipping.postcode')
                    </x-caffelia-shop::form.control-group.label>
                    ...
                    <x-caffelia-shop::form.control-group.control
                        ...
                        :label="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.postcode')"
                        :placeholder="trans('caffelia-shop::app.checkout.cart.summary.estimate-shipping.postcode')"
                    />
