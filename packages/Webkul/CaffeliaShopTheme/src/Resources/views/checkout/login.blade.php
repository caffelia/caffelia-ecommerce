...
<v-checkout-login>
    <div class="flex items-center">
        <span class="cursor-pointer text-base font-medium text-blue-700">
            @lang('caffelia-shop::app.checkout.login.title')
        </span>
    </div>
</v-checkout-login>
                        ...
                        <x-slot:content>
                            ...
                            <x-caffelia-shop::form.control-group>
                                <x-caffelia-shop::form.control-group.label class="required">
                                    @lang('caffelia-shop::app.checkout.login.email')
                                ...
                                <x-caffelia-shop::form.control-group.control
                                    ...
                                    :label="trans('caffelia-shop::app.checkout.login.email')"
                                    placeholder="email@example.com"
                                    :aria-label="trans('caffelia-shop::app.checkout.login.email')"
                                    aria-required="true"
                                />
                            ...
                            <x-caffelia-shop::form.control-group class="!mb-0">
                                <x-caffelia-shop::form.control-group.label class="required">
                                    @lang('caffelia-shop::app.checkout.login.password')
                                </x-caffelia-shop::form.control-group.label>
                                ...
                                <x-caffelia-shop::form.control-group.control
                                    ...
                                    :label="trans('caffelia-shop::app.checkout.login.password')"
                                    :placeholder="trans('caffelia-shop::app.checkout.login.password')"
                                    :aria-label="trans('caffelia-shop::app.checkout.login.password')"
                                    aria-required="true"
                                />
                        ...
                        <x-slot:footer>
                            <div class="flex flex-wrap items-center gap-4">
                                <x-caffelia-shop::button
                                    ...
                                    :title="trans('caffelia-shop::app.checkout.login.title')"
                                    ::loading="isStoring"
                                    ::disabled="isStoring"
                                />
                            </div>
