<!-- SEO Meta Content -->
@push('meta')
    <meta name="description" content="@lang('caffelia-shop::app.checkout.onepage.index.checkout')"/>

    <meta name="keywords" content="@lang('caffelia-shop::app.checkout.onepage.index.checkout')"/>
@endPush
...
>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.checkout.onepage.index.checkout')
    </x-slot>
        ...
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] py-4 max-lg:px-8 max-sm:px-4">
            <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
                <a
                    ...
                    aria-label="@lang('caffelia-shop::checkout.onepage.index.bagisto')"
                >
                    <img
    ...
    <div class="container px-[60px] max-lg:px-8 max-sm:px-4">
        ...
        @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
            <x-caffelia-shop::breadcrumbs name="checkout" />
        @endif
        ...
        <v-checkout>
            <!-- Shimmer Effect -->
            <x-caffelia-shop::shimmer.checkout.onepage />
        </v-checkout>
    </div>
            ...
            <template v-else>
                <div class="grid grid-cols-[1fr_auto] gap-8 max-lg:grid-cols-[1fr] max-md:gap-5">
                    ...
                    <div class="hidden max-md:block">
                        @include('caffelia-shop::checkout.onepage.summary')
                    </div>
                        ...
                        >
                            ...
                            <template v-else>
                                <x-caffelia-shop::button
                                    ...
                                    :title="trans('caffelia-shop::app.checkout.onepage.summary.place-order')"
