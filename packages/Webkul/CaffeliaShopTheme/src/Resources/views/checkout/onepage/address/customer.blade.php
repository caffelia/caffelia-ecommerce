...
>
    ...
    <x-caffelia-shop::shimmer.checkout.onepage.address />
</v-checkout-address-customer>
                    ...
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="mb-4 flex items-center justify-between max-md:mb-2">
                            <h2 class="text-xl font-medium max-sm:text-base max-sm:font-normal">
                                @lang('caffelia-shop::app.checkout.onepage.address.billing-address')
                            </h2>
                        </div>
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                            ...
                            >
                                ...
                                <div class="absolute top-5 flex gap-2 ltr:right-5 rtl:left-5">
                                    <x-caffelia-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                                        <x-caffelia-shop::form.control-group.control
                                            ...
                                            rules="required"
                                            label="{{ trans('caffelia-shop::app.checkout.onepage.address.billing-address') }}"
                                        />
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="text-base">@lang('caffelia-shop::app.checkout.onepage.address.add-new-address')</p>
                                </div>
                            </div>
                        </div>

                        <!-- Error Message Block -->
                        <x-caffelia-shop::form.control-group.error name="billing.id" />

                        <!-- Shipping Address Block if have stockable items -->
                        <template v-if="cart.have_stockable_items">
                            <!-- Use for Shipping Checkbox -->
                            <x-caffelia-shop::form.control-group class="!mb-0 mt-5 flex items-center gap-2.5">
                                <x-caffelia-shop::form.control-group.control
                                    type="checkbox"
                                ...
                                <label
                                    ...
                                    for="use_for_shipping"
                                >
                                    @lang('caffelia-shop::app.checkout.onepage.address.same-as-billing')
                                </label>
                            </x-caffelia-shop::form.control-group>
                            ...
                            >
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    <h2 class="text-xl font-medium max-md:text-lg max-sm:text-base">
                                        @lang('caffelia-shop::app.checkout.onepage.address.shipping-address')
                                    </h2>
                                </div>
                                        ...
                                        <div class="absolute top-5 flex gap-5 ltr:right-5 rtl:left-5">
                                            <x-caffelia-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                                                <x-caffelia-shop::form.control-group.control
                                                    ...
                                                    rules="required"
                                                    label="{{ trans('caffelia-shop::app.checkout.onepage.address.shipping-address') }}"
                                                />
                                            </x-caffelia-shop::form.control-group>
                                ...
                                <x-caffelia-shop::form.control-group.error name="shipping.id" />
                            </div>
                        </template>
                        ...
                        <div class="mt-4 flex justify-end max-md:my-4">
                            <x-caffelia-shop::button
                                ...
                                :title="trans('caffelia-shop::app.checkout.onepage.address.proceed')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
                    ...
                    <form @submit="handleSubmit($event, updateOrCreateAddress)">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            >
                                ...
                                @lang('caffelia-shop::app.checkout.onepage.address.back')
                            </span>
                        </div>
                        ...
                        <x-caffelia-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                            ...
                            <label
                                ...
                                for="save_address"
                            >
                                @lang('caffelia-shop::app.checkout.onepage.address.save-address')
                            </label>
                        </x-caffelia-shop::form.control-group>
                        ...
                        <div class="mt-4 flex justify-end">
                            <x-caffelia-shop::button
                                class="primary-button rounded-2xl px-11 py-3 max-md:rounded-lg max-sm:w-full max-sm:max-w-full max-sm:py-1.5"
                                :title="trans('caffelia-shop::app.checkout.onepage.address.save')"
                                ::loading="isStoring"
                                ::disabled="isStoring"
                            />
                        </div>
