    ...
    >
        <div class="flex justify-between text-right">
            <p class="text-base max-md:font-normal max-sm:text-sm">
                @{{ cart.coupon_code ? "@lang('caffelia-shop::app.checkout.coupon.applied')" : "@lang('caffelia-shop::app.checkout.coupon.discount')" }}
            </p>
            ...
            <p class="text-base font-medium max-sm:text-sm">
                ...
                >
                    ...
                    <form @submit="handleSubmit($event, applyCoupon)">
                        ...
                        <!-- Apply coupon modal -->
                        <x-caffelia-shop::modal ref="couponModel">
                            <!-- Modal Toggler -->
                            <x-slot:toggle>
                                <span 
                                ...
                                >
                                    @lang('caffelia-shop::app.checkout.coupon.apply')
                                </span>
                            </x-slot>
                            ...
                            <x-slot:content class="!px-4">
                                <x-caffelia-shop::form.control-group class="!mb-0">
                                    <x-caffelia-shop::form.control-group.control
                                        ...
                                        name="code"
                                        rules="required"
                                        :placeholder="trans('caffelia-shop::app.checkout.coupon.enter-your-code')"
                                    />
                                ...
                                <div class="flex flex-wrap items-center gap-4 max-md:justify-between">
                                    <div class="flex items-center gap-4 max-md:block">
                                        <p class="text-sm font-medium text-zinc-500 max-md:text-left max-md:text-xs">
                                            @lang('caffelia-shop::app.checkout.coupon.subtotal')
                                        </p>
                                    ...
                                    <x-caffelia-shop::button
                                        ...
                                        :title="trans('caffelia-shop::app.checkout.coupon.button-title')"
                                        ::loading="isStoring"
                                        ::disabled="isStoring"
                                    />
                                </div>
                ...
                >
                    <p 
                        ...
                        title="@lang('caffelia-shop::app.checkout.coupon.applied')"
                    >
                        "@{{ cart.coupon_code }}"
                    </p>
                    ...
                    <span 
                        ...
                        title="@lang('caffelia-shop::app.checkout.coupon.remove')"
                        @click="destroyCoupon"
                    >
                    </span>
                </div>
