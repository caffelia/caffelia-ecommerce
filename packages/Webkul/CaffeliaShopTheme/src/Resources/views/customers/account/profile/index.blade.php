<x-caffelia-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.customers.account.profile.index.title')
    </x-slot>

    <!-- Breadcrumbs -->
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        @section('breadcrumbs')
            <x-caffelia-shop::breadcrumbs name="profile" />
        @endSection
    @endif
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            >
                @lang('caffelia-shop::app.customers.account.profile.index.edit')
            </a>
        ...
        <div class="mt-8 grid grid-cols-1 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('caffelia-shop::app.customers.account.profile.index.first-name')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('caffelia-shop::app.customers.account.profile.index.last-name')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('caffelia-shop::app.customers.account.profile.index.gender')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('caffelia-shop::app.customers.account.profile.index.dob')
                </p>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('caffelia-shop::app.customers.account.profile.index.email')
                </p>
            ...
            <x-caffelia-shop::form action="{{ route('shop.customers.account.profile.destroy') }}">
                <x-caffelia-shop::modal>
                    <x-slot:toggle>
                        <div class="primary-button rounded-2xl px-11 py-3 max-md:hidden max-md:rounded-lg">
                            @lang('caffelia-shop::app.customers.account.profile.index.delete-profile')
                        </div>
                    ...
                    <x-slot:header>
                        <h2 class="text-2xl font-medium max-md:text-base">
                            @lang('caffelia-shop::app.customers.account.profile.index.enter-password')
                        </h2>
                    </x-slot>
                    ...
                    <x-slot:footer>
                        ...
                        >
                            @lang('caffelia-shop::app.customers.account.profile.index.delete')
                        </button>
                    </x-slot>
                </x-caffelia-shop::modal>
