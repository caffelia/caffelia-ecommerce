<x-caffelia-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.customers.account.reviews.title')
    </x-slot>

    <!-- Breadcrumbs -->
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        @section('breadcrumbs')
            <x-caffelia-shop::breadcrumbs name="reviews" />
        @endSection
    @endif
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <v-product-reviews>
            ...
            <x-caffelia-shop::shimmer.customers.account.reviews :count="4" />
        </v-product-reviews>
                    ...
                    @else
                        ...
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            ...
                            <p
                                ...
                                role="heading"
                            >
                                @lang('caffelia-shop::app.customers.account.reviews.empty-review')
                            </p>
                        </div>
                    @endif
                </template>
