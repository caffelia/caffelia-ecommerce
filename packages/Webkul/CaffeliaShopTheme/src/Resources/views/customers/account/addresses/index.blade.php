<x-caffelia-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.customers.account.addresses.index.add-address')
    </x-slot>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-medium max-md:text-xl max-sm:text-base ltr:ml-2.5 md:ltr:ml-0 rtl:mr-2.5 md:rtl:mr-0">
                    @lang('caffelia-shop::app.customers.account.addresses.index.title')
                </h2>
            </div>
                            ...
                            <div class="flex gap-4 max-sm:gap-2.5">
                                @if ($address->default_address)
                                    <div class="label-pending block h-fit w-max px-2.5 py-1 max-md:px-1.5">
                                        @lang('caffelia-shop::app.customers.account.addresses.index.default-address') 
                                    </div>
                                @endif
                                ...
                                <x-caffelia-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                                    ...
                                    <x-slot:menu class="!py-1 max-sm:!py-0">
                                        <x-caffelia-shop::dropdown.menu.item>
                                            <a href="{{ route('shop.customers.account.addresses.edit', $address->id) }}">
                                                <p class="w-full">
                                                    @lang('caffelia-shop::app.customers.account.addresses.index.edit')
                                                </p>
                                            </a>    
                                        </x-caffelia-shop::dropdown.menu.item>
                                        ...
                                        <x-caffelia-shop::dropdown.menu.item>
                                            ...
                                            >
                                                <p class="w-full">
                                                    @lang('caffelia-shop::app.customers.account.addresses.index.delete')
                                                </p>
                                            </a>
                                        </x-caffelia-shop::dropdown.menu.item>
                                        ...
                                        @if (! $address->default_address)
                                            <x-caffelia-shop::dropdown.menu.item>
                                                ...
                                                >
                                                    <button>
                                                        @lang('caffelia-shop::app.customers.account.addresses.index.set-as-default')
                                                    </button>
                                                </a>
                                            </x-caffelia-shop::dropdown.menu.item>
                                        @endif
        ...
        @else
            ...
            <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                ...
                <p
                    ...
                    role="heading"
                >
                    @lang('caffelia-shop::app.customers.account.addresses.index.empty-address')
                </p>
            </div>    
        @endif
    </div>
