<x-caffelia-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('caffelia-shop::app.customers.account.wishlist.page-title')
    </x-slot>

    <!-- Breadcrumbs -->
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        @section('breadcrumbs')
            <x-caffelia-shop::breadcrumbs name="wishlist" />
        @endSection
    @endif
    ...
    <div class="mx-4 flex-auto">
        ...
        <v-wishlist-products>
            ...
            <x-caffelia-shop::shimmer.customers.account.wishlist :count="4" />
        </v-wishlist-products>
    </div>
            ...
            <div>
                ...
                <template v-else>
                    <div class="flex items-center justify-between">
                        ...
                        >
                            @lang('caffelia-shop::app.customers.account.wishlist.delete-all')
                        </div>
                    ...
                    <template v-if="wishlistItems.length">
                        ...
                        >
                            <x-caffelia-shop::shimmer.customers.account.wishlist />
                        </v-wishlist-products-item>
                    </template>
                    ...
                    <template v-else>
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            ...
                            <p
                                ...
                                role="heading"
                            >
                                @lang('caffelia-shop::app.customers.account.wishlist.empty')
                            </p>
                        </div>
                    </template>
                </template>
                                ...
                                <div class="grid gap-y-2.5 max-md:w-full max-md:gap-y-0">
                                    ...
                                    >
                                        <div class="grid gap-2">
                                            <div>
                                                ...
                                                >
                                                    @lang('caffelia-shop::app.customers.account.wishlist.see-details')
                                    ...
                                    <div class="max-md:block md:hidden">
                                        ...
                                        <a
                                            ...
                                            @click="remove"
                                        >
                                            @lang('caffelia-shop::app.customers.account.wishlist.remove')
                                        </a>
                                    ...
                                    <div class="flex gap-5 max-md:mt-2.5">
                                        ...
                                        @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                            ...
                                            <x-caffelia-shop::button
                                                ...
                                                :title="trans('caffelia-shop::app.customers.account.wishlist.move-to-cart')"
