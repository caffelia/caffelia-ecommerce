...
Refer to this [Medusa Admin User Guide](https://docs.medusajs.com/user-guide/settings/regions) to learn how to manage the payment providers available in a region using the dashboard.

***

## What is a Payment Module Provider?

The Payment Module Provider handles payment processing in the Medusa application. It integrates third-party payment services, such as [Stripe](https://docs.medusajs.com/commerce-modules/payment/payment-provider/stripe).
...
Refer to [this guide](https://docs.medusajs.com/references/payment/provider) on how to create a payment provider for the Payment Module.

After you create a payment provider, you can enable it as a payment provider in a region using the [Medusa Admin dashboard](https://docs.medusajs.com/user-guide/settings/regions).
...
Learn more about this option in the [Module Options](https://docs.medusajs.com/commerce-modules/payment/module-options) guide.
...
A registered payment provider is represented by the [PaymentProvider data model](https://docs.medusajs.com/references/payment/models/PaymentProvider) in the Medusa application.
