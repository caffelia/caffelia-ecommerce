...
The Medusa application creates a link between the [Customer](https://docs.medusajs.com/references/customer/models/Customer) data model of the [Customer Module](https://docs.medusajs.com/commerce-modules/customer) and the `AccountHolder` data model of the Payment Module.
...
Learn more about this link in the [Link to Other Modules](https://docs.medusajs.com/commerce-modules/payment/links-to-other-modules) guide.
...
Learn more about implementing these methods in the [Create Payment Provider guide](https://docs.medusajs.com/references/payment/provider).
